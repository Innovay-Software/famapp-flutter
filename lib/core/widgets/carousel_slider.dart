...
class InnovayCarouselSlider extends StatefulWidget {
  ...
  @override
  InnovayCarouselSliderState createState() => InnovayCarouselSliderState(_carouselController);
}

class InnovayCarouselSliderState extends State<InnovayCarouselSlider> with TickerProviderStateMixin {
  ...
  InnovayCarouselSliderState(this.carouselController);
  ...
  @override
  void didUpdateWidget(InnovayCarouselSlider oldWidget) {
