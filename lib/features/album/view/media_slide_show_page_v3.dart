...
// import 'package:famapp/pages/album/widgets/media_slide_show_folder_file_provider.dart';
...
// import '../../innovay/widgets/app_bar_base.dart';
...
//   late FolderFileModel _startingFile;
//   late FolderFileModel _currentFile;
...
//   void initState() {
//     super.initState();
//     DebugManager.log("InitialIndex = ${widget.initialIndex}");
...
//     return Scaffold(
//       appBar: InnovayAppBarBase(
//         Colors.black.withOpacity(0.8),
//         Colors.white,
//         '${_currentIndex + 1}/${widget.folder.files.length}${kDebugMode ? ' & ${widget.folder.files[_currentIndex].id}' : ''}',
//         [
//           IconButton(
...
//                     // imageProvider: MediaSlideShowItemWidget(folderFile: widget.folder.files[index]),
//                     imageProvider: MediaSlideShowFolderFileProvider(widget.folder.files[index]),
//                     initialScale: PhotoViewComputedScale.contained * 0.8,
//                     minScale: PhotoViewComputedScale.contained * 0.8,
//                     maxScale: PhotoViewComputedScale.covered * 1.1,
//                     heroAttributes: PhotoViewHeroAttributes(tag: 'folderFile.${widget.folder.files[index].id}'),
//                   );
//                 },
//                 itemCount: widget.folder.files.length,
...
//                       value:
//                           progress == null ? null : progress.cumulativeBytesLoaded / (progress.expectedTotalBytes ?? 1),
//                     ),
//                   ),
//                 ),
...
//                                 style:
//                                     const TextStyle(overflow: TextOverflow.ellipsis, color: Colors.white, fontSize: 12),
//                               )
//                             : InnovayText(
//                                 _currentFile.remark.isEmpty ? '添加备注' : _currentFile.remark,
...
//     InnovayGlobalData.mediaFileDownloader.add(folderFile);
//     // if (folderFile.fileType == 'image') {
//     //   FileUtils.downloadImageFile(context, folderFile.fileUrl, folderFile.aliyunFileSignatureHeaders, () {
//     //     SnackBarManager.displayMessage('下载成功');
//     //   });
//     // } else if (folderFile.fileType == 'video') {
//     //   FileUtils.downloadVideoFile(context, folderFile.fileUrl, folderFile.aliyunFileSignatureHeaders, () {
//     //     SnackBarManager.displayMessage('下载成功');
//     //   });
//     // }
//   }
...
//           child: Container(
//             padding:
//                 EdgeInsets.only(left: 15, right: 15, top: 15, bottom: max(15, MediaQuery.of(context).padding.bottom)),
...
//                     Row(children: [
//                       const SizedBox(width: 5),
//                       InnovayText(_currentFile.fileName.split('.').last.toUpperCase(),
//                           color: InnovayConfig.colors.textColorLight9),
...
//                         onPressed: () async {
//                           ClipboardData data = ClipboardData(text: _currentFile.fileDownloadUrl);
