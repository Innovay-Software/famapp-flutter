...
//                   var item = widget.folder.files[index].fileUrl;
//                   Widget image = MediaSlideShowItemWidget(folderFile: widget.folder.files[index]);
...
//                   _currentIndex = index;
//                   _currentFile = widget.folder.files[_currentIndex];
//                   // rebuild.add(index);
//                   setState(() {});
//                 },
